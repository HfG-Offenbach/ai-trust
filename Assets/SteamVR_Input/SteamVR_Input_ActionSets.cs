...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_routeManager p_routeManager;
        ...
        public static SteamVR_Input_ActionSet_routeManager routeManager
        {
            get
            {
                return SteamVR_Actions.p_routeManager.GetCopy<SteamVR_Input_ActionSet_routeManager>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_routeManager = ((SteamVR_Input_ActionSet_routeManager)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_routeManager>("/actions/routeManager")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.routeManager};
        }
    }
}
