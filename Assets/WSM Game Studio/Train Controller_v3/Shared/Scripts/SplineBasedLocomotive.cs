...
namespace WSMGameStudio.RailroadSystem
{
    public class SplineBasedLocomotive : SplineFollower, ILocomotive, IRailwayVehicle
    {
        ...
        [SerializeField] private float _accelerationRate = 6f;
        [SerializeField] private float _brakingDecelerationRate = 20f;
        ...
        // public float CurrentSpeed { get { return _currentSpeed; } set { _currentSpeed = Mathf.Abs(value); } }
