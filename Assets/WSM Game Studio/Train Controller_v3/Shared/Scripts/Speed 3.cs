namespace WSMGameStudio.RailroadSystem
{
    public static class Speed
    {
        ...
        /// <param name="kilometersPerHour"></param>
        /// <returns></returns>
        public static float Convert_KPH_to_MPH(float kilometersPerHour)
        {
            return kilometersPerHour * 0.621371f;
        }
        ...
        /// <param name="kilometersPerHour"></param>
        /// <returns></returns>
        public static float Convert_MPH_to_KPH(float kilometersPerHour)
        {
            return kilometersPerHour * 1.60934f;
        }
    }
}
